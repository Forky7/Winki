...
var os = require('os');
	http = require('http');
// Hem creat el constructor:

var ResumenEstadisticas = function (id, timestamp, memoriaLibre, memoriaTotal,usoCPU60seg) {
...
Agente.prototype.activar = function() {	
	...
	contador = contador +1,
		...
		if (contador % 60 == 0){
			var resumen = new ResumenEstadisticas (self.id, new Date().getTime(), os.freemem(), os.totalmem(),cpu);
...
if (process.argv.length <3){
	console.warn('Numero de argumentos insuficiente.');
	}else{
